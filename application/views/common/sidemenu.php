...
<?php } ?>
    ...
    <!-- 07-09-2020 create date -->
    <?php if($this->session->userdata('user_type') == 1 ){?>
      <li <?php echo $activeclass == 'getReferredByUser' ? 'class="active"' : 'class=""'?>><a href="<?php echo base_url('owner/getReferredByUser')?>"><i class="material-icons">person_add_alt_1</i> REFER A FRIEND</a></li>
    <?php } ?>
    <!-- 07-09-2020 create date -->
...
<div class="bg-theme text-white bgback">
