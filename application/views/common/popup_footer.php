        ...
        $.ajax({
           ...
           success: function(result){
                 ...
                 $('#mySelect')
                    ...
                    //$('#tenant_unit').val(value);
                   //  $('#tenant_unit_select').hide();
...
//select unit and tenatn by default
function tenantUnit(){
  
 var unit_id = $('#mySelect1').val();
//alert(unit_id);
        $.ajax({ 
           type: "POST",
           url: "/financial/getAllTenant/"+unit_id, 
           data: {unit_id: $('#mySelect1').val()},
           //cache:false,
           dataType: 'json',

           success: function(result){
            // console.log(result);
            $('#tenant_unit_select').text('');
             ...
             // alert(result.data);
              $.each(result.data, function (i, data) {
                 ...
                 //alert("hello");
                  ...
                  $('#tenant_unit_select').append($("<option></option>")
                                .attr("value",data.id)
                                .text(data.firstname)); 
                ...
                //$('#tenant_unit_select').text(data.firstname);
