<div class="contnet-area">
   ...
   <div class="container container_padding">
      ...
      <h3 style="margin: 20px;"><a class="btn btn-raised btn-primary" href="<?php echo base_url('owner/requests/')?>">Back to all requests</a> <span style="float: right;"> <a class="btn btn-raised btn-primary" href="<?php echo base_url('owner/maintenance_request_printer/').$requestbasicinfo['id'];?>">Printer-friendly version</a></span></h3>
           ...
           <div class="col-lg-4 col-md-4 col-sm-5 col-xs-5 ">
              ...
              <div class="filter pull-right open_close_mobile_view" >
                 ...
                 <div class="switch">
                  ...
                  <input type="checkbox" id="status"  name="status"  value="<?php echo $requestbasicinfo['status'];?>" <?php if ($requestbasicinfo['status']== 'Open') {?> checked="" <?php
          ...
          <div class="address" style="margin-left: 15px;">
            ...
            <div class="col s12" >
               ...
               <h5 class="title" style="margin-top:20px;">
                   ...
                   <i class="material-icons" data-toggle="modal" data-target="#instructionsModal">edit</i>
...

                {
                  ...
                  <div id="<?php echo $filename[0]?>"  >
                     ...
                     <div style="float: left; margin: 10px; margin-left: 0px;">
                      ...
                      <a <?php  if($filename[1] == pdf){ ?>class="pdf" href="<?php echo base_url('upload/request_doc/').$requestdoc['file_name']?>" <?php }else{ ?> class="example-image-link" href="<?php echo base_url('upload/request_doc/').$requestdoc['file_name']?>" data-lightbox="example-set" <?php } ?>>
...
<!-- 
                       <a class="example-image-link" href="<?php echo base_url('upload/request_doc/').$requestdoc['file_name']?>" data-lightbox="example-set">

                        <img  src="<?php echo base_url('upload/request_doc/').$requestdoc['file_name']?>" class="example-image img-thumbnail size_image">
                      </a> -->
                    ...
                    <div class="col-md-12 col-sm-12 col-" id="myTabContent">
                      ...
                      <div class="tab-pane fade show active" id="property" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <form id="requestUpdateForm">
                              ...
                              <input type="hidden" id="unit_id" name="unit_id" value="<?php echo $requestbasicinfo['unit_id']; ?>">


                              <input type="hidden" id="property_id" name="property_id" value="<?php echo $requestbasicinfo['property_id']; ?>">
                   ...
                   ?>
                     ...
                     <!-- <div class="row">
                        ...
                        <div class="col-md-8" style=" word-break: break-all;">
                          ...
                          <?php //echo $getupdaterequest['update_content']; ?>
            ...
            <div class=" white work-orders-and-participants">
               ...
               <div id="ember2033" class="row ember-view">
                     ...
                     <h3 class="work_order">Work Orders</h3>
                      ...
                      <div>
                        ...
                        <?php
                         ...
                         <a  style="color: #009688;"class="simple-ajax-popup-align-top assign_style   pull-right" href="/owner/getRequestById/<?php echo $requestbasicinfo['id'];?>">
                ...
                <div>
                  ...
                  <p><input type="checkbox" onclick="maintenance_views()" class="chackbox font-color" id="chackbox" name="check"   style="height: 16px;width: 24px;float: left;"><span>Include Closed</span></p>
            ...
            <div>
              ...
              Managed By
                ...
                <a class="clickable edit-request edit_style" data-ember-action="" data-ember-action-2026="2026">
                   ...
                   <i class="material-icons" data-toggle="modal" data-target="#billModal">edit</i>
