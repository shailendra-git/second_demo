...
<html>
   ...
   <style>
      .register_button_view
      {
      background: #22548f !important;
    ...
    .btn-primary:focus, .btn-primary.focus
     {
      box-shadow: 0 0 0 0px rgba(0, 123, 255, 0.5) !important;
     }
      </style>
...
<div id="navbar" style="background-color: #27364f">
      ...
      <div>
         ...
         <center>        <img  style='    max-width: 100%;' src='/assets/images/Onelane-Logo-240x90-white.png'>       <!--  <a href="javascript:void(0)" id="logo" style=" float: none;" class="text-center">Onelane</a> -->      </center>  
            ...
            <div class="row ">
              ...
              <div class="col-md-12">
                 <ul class="list-inline" style="text-align: center;">
                   ...
                   <li class="list-inline-item"> <a href="<?php echo $google_login_btn;  ?>"><button type="button" class="btn btn-primary  google_btn"> <i class="fa fa-google"></i>&nbsp;&nbsp; Register with Google</button></a></li>
                   <li class="list-inline-item"><a class="loginBtn loginBtn--facebook" id="test">
                   <button type="button" class="btn btn-primary register_button_view"> <i class="fa fa-facebook-f"></i>&nbsp;&nbsp; Register with Facebook</button></a></li>
                 </ul>
               </div>
