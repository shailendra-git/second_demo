 ...
 <!-- <header class="md-paper md-paper--2 md-toolbar md-toolbar--fixed bgg"><h4 class="md-title md-title--toolbar"> <a class="btn btn-raised btn-primary" href="<?php echo base_url('owner/edit_request/').$requestbasicinfo['id'];?>"><i class="md-icon material-icons md-text--inherit"></i></a>  &nbsp; WORK ORDER -->
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
           ...
           <div class="col s12 card-body bgg">
               ...
               <h5>
                ...
                <a class="simple-ajax-popup-align-top btn btn-raised btn-primary" href="/maintenance/getInvoiceById/<?php echo $workorderinfo['id'];?>" class="btn2 new_req_btn pull-right">
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
            ...
            <div class="bgg"> 
              ...
              <div style="margin-top: 20px;">
                ...
                <form action="<?php echo base_url('maintenance/work_order_doc_uploadAndDelete');?>" class="dropzone dz-clickable" id=""> 
                      ...
                      <div class="tab-pane fade show active" id="property" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="card col-md-12">
                          ...
                          <div class="card-body">
                            ...
                            <form action="<?php echo base_url('maintenance/work_order_view/').$workorderinfo['id'];?>" method="POST">
