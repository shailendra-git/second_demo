					...
					<tbody class="border1">
						...
						<tr>
							<td>
								...
								&nbsp<span style="color:#009688;"  onclick="sendEmailInvited('<?php echo $team['main_tenant_id'] ?>');"> <i class="fa fa-envelope-o" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Invite Again"></i> </span>                              (Invited)      
								 <br>
							...
							<td class="right-align">
								<a class="simple-ajax-popup-align-top" href="/team/tenantUplodeById/
									<?php echo $team['main_tenant_id'];?>" style="color:#009688;" >                                 Uploaded Docs (
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table_overflow" >
				...
				<table class="border1" width="100%" class="dis" cellpadding="20px" >
					...
					<tbody class="border1">
						...
						<tr>
							<td>
								<a class="simple-ajax-popup-align-top" href="/team/editViewHistoryTenantById/
...
<script>
	function sendEmailInvited($id) {
       
		if (window.confirm("Do you want to invite again")) { 

		   window.location.href = "http://localhost/onelane/team/resendEmailTenant/"+$id;
