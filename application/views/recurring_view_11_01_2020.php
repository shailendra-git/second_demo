                  ...
                  <div class="dropdown">
                    <button class="btn btn-raised btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" style="margin-bottom: 20px;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      if(!empty($financial_id)){
                        $property_select = $this->property_model->getPropertyDataTenantSelect($financial_id);
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="<?php echo base_url('financial/recurring/')?>">All Properties</a>
                      <?php 
                        ...
                        {?>
                           ...
                           <!-- <a class="dropdown-item" href="<?php echo base_url('owner/property_basicinfo/'.$value['id'].'/basic-info')?>"><?php echo substr( $value['address'],0,30)?></a> -->
                            <a class="dropdown-item" href="<?php echo base_url('financial/recurring/'.$value['id'])?>"><?php echo substr( $value['address'],0,30)?></a>
          ...
          <div class="action-top d-flex">
            <table class="table table-hover" id="userstatusdata">
              ...
              foreach ($getFinancialData as $data) {
                ...
                <tr class="transaction_<?php echo $data['id']; ?>" style="display:none">
                  <td></td>
                    <td colspan="5">
                 <p>Payments</p>
                 <br>
...
// if(start_date == '' || end_date == ''  || status == ''  || category_id == ''){
  //alert('not found');
 var trHTML = '<tr><td colspan="6"><center>NO RECORD FOUND</center></td></tr>';
 //} 
   $.ajax({
                 ...
                 if(data.payment_type == 2) {
                  ...
                  $.each(data.paymentdata, function (i,paymentdata){
                   //alert(paymentdata.p_id);
                     trHTML += '<tr class="transaction_'+data.id+'" style="display:none;"><td></td><td colspan="5"><p>Payments</p><br><p>Succeeded  &nbsp&nbsp#'+data.id+'</p><p>$'+paymentdata.p_amount+' paid on '+paymentdata.p_date+'. Manual Override.</p></td></tr>';
                  });
                 // trHTML +="</tr>";
                }
