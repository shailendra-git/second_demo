...
<!-- </div> -->
  ...
  <div class="container">
    ...
    <form action="<?php echo base_url('financial/IncomeExpenseData')?>" method="post"> 
      <div class="card col-lg-12 col-md-12 col-sm-12 col-xs-12 card2">
        <div class="action-top d-flex">
          ...
          <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
           <span style="font-size:12px" id="showdatetype" class="due">Paid date from</span> 
           <input type="text" id="datepicker" placeholder="Any" name="s_date" autocomplete="off" value="<?php echo $start_date; ?>" required="" class="any"><span class="to">to</span> 
           <input type="text" id="datepicker1" placeholder="Any" name="e_date" autocomplete="off" value="<?php echo $end_date; ?>" required="" class="due1"> 
           <button onclick="leasePayment();"class="btn btn-primary btn2" style="background-color:#008276;color:#ffffff"><i class="fa fa-search" aria-hidden="true"></i></button> 
          <button type="button" onclick="submitExportIncome()"   class="btn btn2" style="background-color:#008276; color:#ffffff;"><i class="fa fa-download" aria-hidden="true"></i></button>
          </div>
      </div>
      </div>
    </form>
    <form  id="submit_data_income" method="POST" action="<?php echo base_url('financial/incomeAndExpense/'); ?>">
  ...
  <!-- start first table section -->
      <div class="row col-md-12 bg1 bg2" style="overflow-x: auto !important;">
      <div class="col-md-12">
      <table cellspacing="10" border="1"  style="text-align:center;" class="tabl">
        <tr>
          <th>CATEGORY</th>
          <?php
          ...
          <tr>
            ...
            //echo $status;
              foreach ($months_data['months'] as $value) {
                ...
                $getMonthValue = $this->financial_model->getMonthData($start_date,$end_date,$status,$category['id']);
               // exit;
                if(!empty($getMonthValue['sumOfAmount'])  && $getMonthValue['sumOfAmount'] > 0){
                ?>
                <td><?php echo $getMonthValue['sumOfAmount']; ?></td>
   ...
   <?php
              ...
              foreach ($months_data['months'] as $value) {
                $start_date = $value;
                $end_date = date("Y-m-t",strtotime($start_date));
                $getMonthValue = $this->financial_model->getMonthData($start_date,$end_date,$status,0);
               //  echo "<pre>";
               //  print_r($getMonthValue);
               
                if(!empty($getMonthValue['sumOfAmount'])){
                ?>
                <td><?php echo $getMonthValue['sumOfAmount']; ?></td>
                <!--  <td><?php echo $start_date ."   ----  ".$end_date;?></td>  -->
                <?php
    ...
    <!-- start second table section -->
      <div class="row col-md-12 bg1 bg2" style="overflow-x: auto !important;">
      <div class="col-md-12">
      <table cellspacing="10" border="1" style="text-align:center; " class="tabl tab2">
        <tr>
