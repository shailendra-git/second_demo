      ...
      <div class="card col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="action-top d-flex">
          ...
          <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
           ...
           <input type="text" id="datepicker" placeholder="Any" name="s_date" autocomplete="off" value="<?php echo $start_date; ?>" required=""> to 
           <input type="text" id="datepicker1" placeholder="Any" name="e_date" autocomplete="off" value="<?php echo $end_date; ?>" required=""> 
          ...
          <button type="button" onclick="submitExportIncome()"   class="btn" style="background-color:#008276; color:#ffffff;"><i class="fa fa-download" aria-hidden="true"></i></button>
          </div>
      </div>
      </div>
    </form>
