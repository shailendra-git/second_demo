           ...
           <!--    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
              ...
              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                 ...
                 <?php 
                    ...
                    ?>
                    <tr>
                       <td style="padding-top:40px;"><?php echo $value; ?></td> 
                     </tr>
                    <?php
                  }
                  ?>
                 ...
                 <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 duee" style="overflow-x: auto; ">
                  ...
                  <tr>
                    ...
                    if($value == 'Paid'){
                      foreach ($months_data['month'] as $value) {
                       ...
                       // exit;
                        ...
                        ?>
                        <td style="padding-top:40px;"><?php echo $getLeaseValue['sumOfAmount']; ?></td>
                    ...
                    if($value == 'Balance'){
                      foreach ($months_data['month'] as $value) {
                        ...
                        // exit; 
                       // exit;
                        if(!empty($getLeaseValue['sumOfAmount'])  && $getLeaseValue['sumOfAmount'] > 0){
                        ?>
                        <td style="padding-top:40px;"><?php echo $getLeaseValue['sumOfAmount']; ?></td>
                        <!--  <td><?php echo $start_date ."   ----  ".$end_date;?></td>  -->
                        <?php
