        ...
        <div class="row">
          ...
          ?>
           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            ...
            ?>   
          <div class="<?php if(!empty($tenantData['id'])) { echo  'col-lg-7 col-md-7 col-sm-4 col-xs-12'; }else{ echo 'col-lg-11 col-md-11 col-sm-4 col-xs-12'; } ?>">
                  ...
                  <a <?php  if($filename[1] == pdf){ ?>class="pdf" href="<?php echo base_url('upload/govt_doc/').$tenantdoc['file_name']?>" <?php }else{ ?> class="example-image-link" href="<?php echo base_url('upload/govt_doc/').$tenantdoc['file_name']?>" data-lightbox="example-set" <?php } ?>>
                     ...
                     if($filename[1] == pdf){
                      ...
                      <?php
                          ...
                          ?>
                    <!-- <a class="example-image-link" href="<?php echo base_url('upload/govt_doc/').$tenantdoc['file_name']?>" data-lightbox="example-set"> -->
                   <img  src="<?php echo base_url('upload/govt_doc/').$tenantdoc['file_name']?>" class="example-image img-thumbnail size_image">
                  <?php
                  }
                  ?>
                  </a>
              ...
              <div style="float: left; margin: 10px; margin-left: 0px;">
               ...
               if($filename[1] == pdf){
                ...
                <?php
                  ...
                  ?>
                  <!-- <a class="example-image-link" href="<?php echo base_url('upload/renter_doc/').$tenantdoc['file_name']?>" data-lightbox="example-set"> -->
                     <img  src="<?php echo base_url('upload/renter_doc/').$tenantdoc['file_name']?>" class="example-image img-thumbnail size_image">
                  <?php
                }
                ?>
                   </a>
                ...
                <div class="card" style="padding: 10px; margin-top:52px;"> 
                  <div id="showImages" class="div_showimg">
                    ...
                    <div style="float: left; margin: 10px; margin-left: 0px;">
                      ...
                      <!-- <a class="example-image-link" href="<?php echo base_url('upload/request_doc/').$tenantdoc['file_name']?>" data-lightbox="example-set"> -->
                       <img  src="<?php echo base_url('upload/request_doc/').$tenantdoc['file_name']?>" class="example-image img-thumbnail size_image">
                      <?php
                    }
                    ?>
                      </a>
