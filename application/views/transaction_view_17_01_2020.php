                ...
                <div class="filter pull-left">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="<?php echo base_url('financial/transaction/')?>">All Properties</a>
                      <?php 
                        ...
                        {?>
                           ...
                           <!-- <a class="dropdown-item" href="<?php echo base_url('owner/property_basicinfo/'.$value['id'].'/basic-info')?>"><?php echo substr( $value['address'],0,30)?></a> -->
                            <a class="dropdown-item" href="<?php echo base_url('financial/transaction/'.$value['id'])?>"><?php echo substr( $value['address'],0,30)?></a>
