                ...
                <div>
...

                  {
                    ...
                    <div id="<?php echo $filename[0]?>"  >
                       ...
                       <div style="float: left; margin: 10px; margin-left: 0px;">
                        <a <?php  if($filename[1] == pdf){ ?>class="pdf" href="<?php echo base_url('upload/workorder_doc/').$requestdoc['file_name']?>" <?php }else{ ?> class="example-image-link" href="<?php echo base_url('upload/workorder_doc/').$requestdoc['file_name']?>" data-lightbox="example-set" <?php } ?>>
