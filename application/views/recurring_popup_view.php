              ...
              <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12 " >
                 ...
                 <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12" id="hidden_div" style="display:none;">
                  <div class="form-group bmd-form-group is-filled"  >
                    ...
                    <!-- <input type="text" value="" id="tenant_unit"> -->
                    <div class="select-wrapper">
                       <select  id="mySelect1" name="unit_id" class="form-control" required=""  onchange="tenantUnit();" >
           ...
           ?>
            <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
              <div class="form-group bmd-form-group is-filled"  id="unit_hide">
                <label for="address" class="bmd-label-floating">Unit *</label>
                <div class="select-wrapper">
                   <select  id="unit" name="unit_id" class="form-control unit_tenant" required="" >
                    <?php
                        ...
                        <?php 
                        //echo $unit['id'];
                      //  $select_tenant = $this->financial_model->getAllTenant($unit['id']);
                      // echo "hello";
                      // print_r($select_tenant);
                      // exit;
                      }
                        ?>
                  </select> 
            ...
            <div class="row bottom">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                <div class="form-group ">
                  ...
                  <input type="radio" name="payment" value="team"  onclick="teamMember();">Your Team
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group ">
                  ...
                  <label for="group_data" id="group_text" class="bmd-label-floating">Tenant Group *</label><br>
                   ...
                   <select  id="tenant_unit_select" class="form-control" name="tenant">
                  ...
                  <div class="select-wrapper" id="property_contacts" style="display:none;">
                       ...
                       <select  id="team_unit_select" class="form-control" name="team">
...
$("#select_month_weekly").on('change', function() {
 ...
 $( "#start_date" ).datepicker({ dateFormat: 'yy-mm-dd' , minDate: 0 }).val();
 $( "#end_date" ).datepicker({ dateFormat: 'yy-mm-dd' , minDate: 0 }).val();

// function teamMember(){

//  var property_id = $("#financialpropertydata").val();

//   // alert(property_id);
//        $.ajax({ 
//            type: "POST",
//            url: "/financial/getAllTeam/"+property_id, 
...
//                  //alert("hello");
//                   // $('#unit_select').hide();
//                   // $('#tenant_unit_select').show();

//                     $('#team_unit_select').append($("<option></option>")
//                                 .attr("value",data.id)
//                                 .text(data.firstname)); 
