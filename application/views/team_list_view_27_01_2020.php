   ...
   <div class="container">
      ...
      <div class="row bg">
         ...
         <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12 "  >
            ...
            <div><a class=" btn2 new_req_btn add_services_mobile  simple-ajax-popup-align-top btn btn-raised btn-primary" href="/team/addServicePro" >
            ...
            if ($this->session->userdata('user_type')!='4') {?>
               ...
               <a style="margin-right: 10px;" class=" btn2 new_req_btn add_services_mobile  simple-ajax-popup-align-top btn btn-raised btn-primary" href="/team/addPropertyUser" >
