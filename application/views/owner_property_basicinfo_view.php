    ...
    <div class="tab-pane fade basic_indo_margin <?php echo $current_tab=='basic-info' ? 'show active' : ''?>" id="property" role="tabpanel" aria-labelledby="home-tab">
         ...
         <div id="showImages">
            ...
            <div style="float: left; margin: 10px; margin-left: 0px;">
                ...
                <a <?php  if($filename[1] == pdf){ ?>class="pdf" href="<?php echo base_url('upload/property_doc/').$propertydoc['file_name']?>" <?php }else{ ?> class="example-image-link" href="<?php echo base_url('upload/property_doc/').$propertydoc['file_name']?>" data-lightbox="example-set" data-lightbox="example-set" <?php } ?>>
              <?php
               if($filename[1] == pdf){
                ?>
