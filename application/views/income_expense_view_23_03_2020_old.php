  ...
  <!-- start first table section -->
   ...
   <?php
              ...
              foreach ($months_data['months'] as $value) {
                ...
                $getRecurringMonthvalue = $this->financial_model->getLeaseLedger($start_date,$end_date,$status,0,$financial_id);
               //  echo "<pre>";
               //  print_r($getMonthValue);
                ...
                //$totalMonth = $getMonthValue['sumOfAmount'] + $getRecurringMonthvalue['sumOfRecurringAmount'];
                if(!empty($getRecurringMonthvalue['sumOfAmount'])){
                ?>
                <td><?php echo $getRecurringMonthvalue['sumOfAmount']; ?></td>
                <!--  <td><?php echo $start_date ."   ----  ".$end_date;?></td>  -->
                <?php
                 }else{
                ?>
