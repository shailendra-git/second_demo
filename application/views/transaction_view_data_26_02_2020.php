      ...
      <div class="row col-md-10 bg">
         ...
         <div class="col-md-12">
           <div class="col-md-6">
             ...
             <br>
             <h6><span><?php echo ucfirst($transaction_data['group_name']); ?></span> <i class="fa fa-long-arrow-right" aria-hidden="true"></i> <span>Demo</span></h6>
             <br>
             <br>
             <h6><span><?php echo ucfirst('Payment made offline :'); ?></span></h6>
             <br>
             <h6><span><?php echo ucfirst('test'); ?></span></h6>
             <br>
             <?php
        ...
        <div class="col-md-12">
          ...
          <div id="showImages">
            ...
            <div style="float: left; margin: 10px; margin-left: 0px;">
               <a class="example-image-link" href="<?php echo base_url('upload/transaction_doc/').$transactiondoc['file_name']?>" data-lightbox="example-set">
