<header class="md-paper md-paper--2 md-toolbar md-toolbar--fixed bgg"><h4 class="md-title md-title--toolbar"> <a class="btn btn-raised btn-primary" href="<?php echo base_url('owner/edit_request/').$requestbasicinfo['id'];?>"><i class="md-icon material-icons md-text--inherit">fast_rewind</i></a>  &nbsp; Maintenance Request Print View
...
<div class="">
   <div class="container container_padding">
      <h3 class="padd-top"></h3>
      <div class="row">

         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border_col">
          <div class="row">
           ...
           <div class="col-lg-2 col-md-2 col-sm-7 col-xs-7">
            <form id="asignStatusFormPrint"  class="pull right">
              <input type="hidden" id="id" name="id" value="<?php echo $requestbasicinfo['id']?>">
            
            <div class="filter open_close_mobile_view open_rel  " >
               <div class="switch">
                  <label class="c_p_btn">
                 ...
                 <div class="row">
                    <div class="col-md-12 col-sm-12 col-" id="myTabContent">
                      <div class="tab-pane fade show active" id="property" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <form id="requestUpdateFormPrint">
                    ...
                    <div class="col-md-12 col-sm-12 col-" id="myTabContent">
                      <div class="tab-pane fade show active" id="property" role="tabpanel" aria-labelledby="home-tab">
                        <div class="card col-md-12">
                          <div class="card-body">
                            <form action="<?php echo base_url('owner/maintenance_request_printer/').$requestbasicinfo['id'];?>" method="POST">
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border_col" style="margin-top: 20px !important;">
            <div class=" white work-orders-and-participants">
               <div id="ember2033" class="row ember-view">
                ...
                <div>
                  <p><input type="checkbox" onclick="maintenance_views()" class="chackbox font-color" id="chackbox" name="check"   style="height: 16px;width: 24px; float: left;"><span>Show Open Work Orders Only</span></p>
                </div>
          ...
          <?php } } ?>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 bg">
            <div>
              <h1>Participants</h1>
            <h4 class="padd-top">
               Managed By
