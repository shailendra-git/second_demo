...

{
...

	{
		...
		require_once  APPPATH. 'facebook/config.php';
	...
	public function signup()
	{
	   ...
	   // $image_url = base_url('/assets/images/onelanelogo.png');
		...
		if(!isset($_SESSION['access_token'])) {
		      ...
		      $data['google_login_btn'] = $client->createAuthUrl();
...

		{
            ...
            $secretKey = '6Leu-rEZAAAAAFgUWG0rN0TJ3g7kiiDDDL5OMP5D'; 
        ...
        $this->load->view('common/comman_footer');
  ...
  //       ini_set('display_errors', 1); 
     ...
     //       echo "<pre>";
		  ...
		  // exit;
		   $content = $user;
		   $email= $content['email'];
		   $fname= $content['given_name'];
		   $lname= $content['family_name'];

		// $email = "shailendra1.wiseit@gmail.com";
		// $fname = "demo";
		// $lname = "jooo";
		// $email = "demo@demo.com";
		// $data['email'] = $email;

          $user = $this->common_model->CheckUserByEmailCheck($email);
      //print_r($user);
     // exit;
            if($user->num_rows() == 1)
			{
