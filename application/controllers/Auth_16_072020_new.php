...

{
	   ...
	   // $image_url = base_url('/assets/images/onelanelogo.png');
...

		{
			...
			$id = $this->common_model->getUserByEmail($email);
				...
				$registerData =(array('user_type'=> $user_type,'firstname'=>$firstname,'lastname'=>$lastname,'company_name' =>$company_name ,'email'=>$email,'mobile'=>$mobile,'password' =>$password,'user_referral_comments' => $user_referral_comments));
    ...
    public function reChaptchaSignup(){
    	//echo "hello";
    	...
    	$this->load->view('signup_view_rechaptcha',$data);
