...
class Financial extends CI_Controller
{
      ...
      // $data['propertydatatenat'] = $propertydatatenat;
        ...
        foreach ($data['getFinancialData'] as $key => $value) {
           $transaction_id = $value['id'];
            ...
            if($data['getFinancialData'][$key]['payment_source'] =='tenants' )
           {  
            if($data['getFinancialData'][$key]['group_name'] >0)
            {
             $tenant_id = $data['getFinancialData'][$key]['group_name']; 
             $tenant =  $this->financial_model->gettenantdata($tenant_id);
                // print_r($tenant);
                // exit;
              $data['getFinancialData'][$key]['group_name'] = $tenant['firstname'];
            }
            else
            {
              $data['getFinancialData'][$key]['group_name'] = $data['getFinancialData'][$key]['group_name'];

            }
           }
           if($data['getFinancialData'][$key]['payment_source'] =='team')
           {

            if($data['getFinancialData'][$key]['group_name'] >0)
            {
             $team_id = $data['getFinancialData'][$key]['group_name'];
            //$data['getFinancialData'][$key]['group_name']  = $tenant_id;
            $tenant =  $this->financial_model->getteamdata($team_id);
                // print_r($tenant);
                // exit;
              $data['getFinancialData'][$key]['group_name'] = $tenant['firstname'];
            }
    ...
    public function one_time_popup(){
       ...
       // echo $this->session->userdata('financial_id');
        ...
        foreach ($data['propertyAllData'] as $key => $value) {
                ...
                $getTenantWithUnit = $this->financial_model->getAllTenantDataRecurring($property_id);
                // echo "<pre>";
    ...
    public function recurring_popup(){
       ...
       // print_r($propertyUnits);
        ...
        foreach ($data['propertyAllData'] as $key => $value) {
           ...
           $getTenantWithUnit = $this->financial_model->getAllTenantDataRecurringPropertyUnit($property_id);
    ...
    public function transaction_view($transaction_id){
      ...
      $data['transaction_data'] = $this->financial_model->transaction_view_data($transaction_id);
       ...
       if($data['transaction_data']['payment_source'] =='tenants' )
           {  
            if($data['transaction_data']['group_name'] >0)
            {
             $tenant_id = $data['transaction_data']['group_name']; 
             $tenant =  $this->financial_model->gettenantdata($tenant_id);
                // print_r($tenant);
                // exit;
              $data['transaction_data']['group_name'] = $tenant['firstname'];
            }
            else
            {
              $data['transaction_data']['group_name'] = $data['transaction_data']['group_name'];

            }
           }
           if($data['transaction_data']['payment_source'] =='team')
           {

            if($data['transaction_data']['group_name'] >0)
            {
             $team_id = $data['transaction_data']['group_name'];
            //$data['getFinancialData'][$key]['group_name']  = $tenant_id;
            $tenant =  $this->financial_model->getteamdata($team_id);
                // print_r($tenant);
                // exit;
    ...
    //        $cro = $this->financial_model->saveDemo(array('runtime'=>"NOW()"));
    //        exit;
...
public function getPropertyUnitAll()
  ...
  public function getAllTenant($unit_id){

      $propertyUnitsTenant = $this->financial_model->getAllTenantUnit($unit_id);
       //   echo $unit_id;
       // print_r($propertyUnitsTenant);
      
        if(!empty($propertyUnitsTenant)){
             $unitData['data'] = $propertyUnitsTenant;
             $unitData['success'] = 'true';
          }else{
             $unitData['data'] =  '';
   ...
   function getAllTeam($property_id){
    
      $propertyUnitsTeam = $this->financial_model->getAllTeamUnit($property_id);
       //   echo $unit_id;
        // print_r($propertyUnitsTenant);
        // exit;
      
        if(!empty($propertyUnitsTeam)){
             $TeamData['data'] = $propertyUnitsTeam;
             $TeamData['success'] = 'true';
          }else{
             $TeamData['data'] =  '';
 ...
 //       $email_subject = "Your Weekly Financial Report From " . date("dS F" , strtotime("-7 days")). " To " .date("dS F" , strtotime("-1 days"));
 //    // exit;
 ...
 //      $email = 'shailendra.wiseit@gmail.com';
