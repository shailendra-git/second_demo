 ...
 //    	 echo "<pre>";
	...
	public function getReferred(){
     //$data = array();
	  if(!empty($_POST))
	  {
	   ...
	   $email_arr = array();
        ...
        $this->session->set_flashdata('referred','Thank by friend'); 
	 ...
	 public function userListDownload($user_type = 1){
        ...
        header("Expires: 0");
        $headings = "Id,User Type,Parent User Id,Is Active,Firstname,Lastname,Contact Name,Company Name,Email,Password,Forgotcode,Forgotcode Time,Forgot Token,Address,Lat,Lng,mobile,Notes,User Referral Comments,Added By";
            echo $headings;
            echo "\r\n";
