...

{
	...
	public function send_reference_mail($email,$email_type,$data,$email_subject='') { 
...
echo        $this->email->message($body_email); 
	...
	public function CheckUserByEmailCheck($email)
	{
		$this->db->where('email',$email);
